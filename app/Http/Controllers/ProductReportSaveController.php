...
class ProductReportSaveController extends Controller
{
    protected $now;
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $p_report_note            = $request->get('p_report_note');

            $pdo = \DB::connection()->getPdo();
            // calling stored procedure command
            $sql = 'CALL product_report_pc(@o_status, @o_message, :p_access_token, :p_user_id, :p_product_id, :p_report_note)';
            ...
            $stmt->bindParam(':p_report_note', $p_report_note, PDO::PARAM_STR);
