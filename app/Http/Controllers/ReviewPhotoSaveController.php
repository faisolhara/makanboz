...
class ReviewPhotoSaveController extends Controller
{
    protected $now;
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $p_review_value           = intval($request->get('p_review_value'));
            $p_review_note            = $request->get('p_review_note');

            $pdo = \DB::connection()->getPdo();
            // calling stored procedure command
            $sql = 'CALL review_photo_save_pc(@o_status, @o_message, :p_access_token, :p_transaction_line_id, :p_review_value, :p_review_note)';
            ...
            $stmt->bindParam(':p_review_value', $p_review_value, PDO::PARAM_INT);
            $stmt->bindParam(':p_review_note', $p_review_note, PDO::PARAM_STR);
