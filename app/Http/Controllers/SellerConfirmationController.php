...
class SellerConfirmationController extends Controller
{
    protected $now;
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $p_confirm_note           = $request->get('p_confirm_note');

            $pdo = \DB::connection()->getPdo();
            // calling stored procedure command
            $sql = 'CALL seller_confirmation_pc(@o_status, @o_message, :p_access_token, :p_transaction_line_id, :p_confirm_note)';
            ...
            $stmt->bindParam(':p_confirm_note', $p_confirm_note, PDO::PARAM_STR);
