...
class ShoppingCartDelController extends Controller
{
    protected $now;
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $sql = 'CALL shopping_cart_del_pc(@o_status, @o_message, :p_access_token, :p_user_id, :p_product_id, :p_plu_code, :p_delivery_date)';
